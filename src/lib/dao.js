...
class DAO {
  ...
  /**
   * Updates an entry
   * @param {MySQL.Connection} connection - The connection which will do the update...
   * It should be immediatelly released unless in a transaction
  ...
  /**
   * Inserts a new entry
   * @param {MySQL.Connection} connection - The connection which will do the insert...
   * It should be immediatelly released unless in a transaction
  ...
  /**
   * Deletes an entry
   * @param {MySQL.Connection} connection - The connection which will do the deletion...
   * It should be immediatelly released unless in a transaction
